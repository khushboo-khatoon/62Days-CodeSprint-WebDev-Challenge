...
*   **Syntax Highlighting**: Powered by `highlight.js` for a wide variety of programming languages.
*   **Powerful Filtering & Search**:
    *   Full-text search through snippet titles, languages, and tags.
    *   Filter snippets by one or more programming languages.
    *   Filter snippets by one or more tags.
*   **Tagging System**: Organize your snippets with custom tags.
*   **Import/Export**: Backup all your snippets to a JSON file or import them into another browser.
*   **Responsive Design**: A clean and usable interface on both desktop and mobile devices.
*   **Resizable Layout**: Adjust the sidebar width to your preference on desktop.
*   **Automatic Dark/Light Mode**: The theme adapts to your operating system's color scheme.
